...
export default function CreateGroupPage() {
  ...
  const themes = [
    { value: 'poker', name: 'Poker Table', icon: '🎰', description: 'Classic green felt' },
    { value: 'classic', name: 'Classic Dark', icon: '🌙', description: 'Sleek and modern' },
    { value: 'minimal', name: 'Minimal', icon: '✨', description: 'Clean and simple' },
  ];
              ...
              <div className="grid grid-cols-3 gap-4">
                {themes.map((themeOption) => (
                  ...
                  >
                    ...
                    <p className="text-white font-semibold text-sm mb-1">{themeOption.name}</p>
                    <p className="text-gray-400 text-xs">{themeOption.description}</p>
                  </button>
                ))}
              </div>
            </div>
