    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">Your Groups</h1>
            <p className="text-gray-400">Hey {user.name}! Manage your expense groups here</p>
          </div>
          <Button
            variant="ghost"
            onClick={logout}
              ...
              <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                <DialogTrigger asChild>
                  ...
                  >
                    ...
                    <h3 className="text-lg font-semibold text-white mb-1">Create New Group</h3>
                    <p className="text-gray-400 text-sm text-center">Start tracking expenses</p>
                  </motion.div>
                </DialogTrigger>
                <DialogContent className="bg-gray-900 border-gray-800">
                  <DialogHeader>
